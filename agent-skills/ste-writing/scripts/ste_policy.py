...
RULES = {
    ...
    "1.2": Rule("flagged", "wrong_part_of_speech", "Use an approved word only as its specified part of speech"),
    ...
    "1.7": Rule("flagged", "technical_noun_as_verb", "Do not use a technical noun as a verb"),
    ...
    "1.13": Rule("flagged", "technical_verb_as_noun", "Do not use a technical verb as a noun"),
